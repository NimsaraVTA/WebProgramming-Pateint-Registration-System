...
if(isset($_POST['submit'])){
    ...
    if(empty($errors)){
        ...
        if($password===$re_password){
            ...
            $query= "UPDATE user SET password='{$password}', clinic='{$clinic}',is_deleted='0' WHERE username='{$user}'";
...
<ul>
  ...
  <li><a href="admin_list.php">Show Admins</a></li>  
    ...
    <div class="row">
        ...
        if(isset($_GET['username'])){
                        ...
                        $query = "SELECT * FROM user WHERE username='$stud_id' ";
   ...
   <div class="login-wrap">
	<div class="login-html">
		...
		<input id="tab-2" type="radio" name="tab" class="sign-up"><label for="tab-2" class="tab" style=" margin-top:-60px;">Update Admin</label>
		...
		<div class="login-form">
			...
			<div class="sign-up-htm">
				<div class="group">
					...
					<input id="user" type="text" class="input" name="username" required value="<?php if(isset($_GET['username'])){echo $row['username'];} else{echo '';} ?>" readonly>
					...
					<input id="user" type="text" class="input" nrequired value="<?php if(isset($_GET['username'])){echo $row['clinic'];} else{echo '';} ?>" readonly>    
				
					<label for="pass" class="label">Select Clinic</label>
					<select class="input" name="clinic" required value="<?php if(isset($_GET['username'])){echo $row['clinic'];} else{echo '';} ?>">
                    <option>Onco</option>
