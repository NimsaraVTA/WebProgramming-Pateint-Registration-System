...
if(isset($_POST['submit'])){
    ...
    if(empty($errors)){
        ...
        $detail=mysqli_real_escape_string($connection,$_POST['any']);
            ...
            $query= "INSERT INTO doctor_contact (d_name,d_no,d_details,is_deleted) VALUES ('{$user}', '{$cont}', '{$detail}','0')";
...
<div class="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50">
                        ...
                        <span class="login100-form-title p-b-59">Add Doctors' Contacts</span>
                                                                                                           
					<div class="wrap-input100 validate-input" data-validate="Name is required">
						<span class="label-input100">Doctor's Name</span>
						<input class="input100" type="tele" name="name" placeholder="Doctor Name" required>
