...
if(isset($_GET['search'])){
    ...
    $query="SELECT * FROM onco_patient WHERE File LIKE '%{$search}%'";

}else if(empty($_GET['search'])){

$query="SELECT * FROM onco_patient ORDER BY File";
...
if($users){
    ...
    while($user=mysqli_fetch_assoc($users)){
      $userlist.="<tr>";
        ...
        $userlist.="<td><a href=\"OP_update.php?File={$user['File']}\">Edit</a></td>";
        $userlist.="<td><a href=\"OP_delete.php?File={$user['File']}\">Delete</a></td>";
      $userlist.='<tr>';    
...
<div class="topnav" id="myTopnav">
  ...
  <a href="OP_update_b.php">Modify Patient</a>
...
<h2 style="text-align:center; padding:15px;">Patients List - Onco Clinic</h2>
