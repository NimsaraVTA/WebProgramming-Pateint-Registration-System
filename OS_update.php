...
if(isset($_GET['File'])){
    ...
    $query="SELECT * FROM os_patient WHERE File={$p_file} LIMIT 1";
    ...
    if($result_set){
        ...
        header('Location: OS_list.php?query_falied');
    }
}
...
<footer>
    ...
    <h1 style="padding:30px; background:#03506F; text-align:center; color:white;">This page can access for admins of Onco Clinic and Onco Surgeory Clinic only</h1>
