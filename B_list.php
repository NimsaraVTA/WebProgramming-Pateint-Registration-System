...
if(isset($_GET['search'])){
    ...
    $query="SELECT * FROM breast_patient WHERE File LIKE '%{$search}%'";

}else if(empty($_GET['search'])){

$query="SELECT * FROM breast_patient ORDER BY File";
...
if($users){
    ...
    while($user=mysqli_fetch_assoc($users)){
      $userlist.="<tr>";
        ...
        $userlist.="<td><a href=\"B_update.php?File={$user['File']}\">Edit</a></td>";
        $userlist.="<td><a href=\"B_delete.php?File={$user['File']}\">Delete</a></td>";
      $userlist.='<tr>';    
...
body {margin:0;font-family:Arial; background-color: #f6e4d9;}
...
<div class="topnav" id="myTopnav">
  ...
  <a href="B_update_b.php">Modify Patient</a>
...
<h2 style="text-align:center; padding:15px;">Patients List - Breast Clinic</h2>
