...
$query= "DELETE FROM os_patient WHERE File={$p_file} LIMIT 1";
...
<head>
	<meta charset="utf-8">
	<title>Delete Patient - Onco</title>
</head>
...
<ul>
  ...
  <li><a href="OP_list.php">Show Patients</a></li>
  <li><a href="OP_update.php">Modify Patients</a></li>
...
<!--.....................................................................................................-->
    ...
    <div>
     ...
     <label>Delete from Breast Clinic</label>
    </div>
           <br>
    <div>
     <input class="check-breast" type="checkbox" name="check-os" autocomplete="off" onclick="return Validate();" <?php echo ($result == 0) ? "checked" : ""; ?>>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
     <label>Delete from OS Clinic</label>
    </div>        
