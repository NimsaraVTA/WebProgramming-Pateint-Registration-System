...
if(isset($_POST['Submit'])){
    ...
    if(empty($errors)){
        ...
        $_SESSION['dupfile']=$dup['File'];
        
        if($_SESSION['dupfile']===$File){
            
            echo "<script language='javascript'>
               
               alert('This File Number is Already Registered!');
               
               </script>";
        }else{
            
$query= "INSERT INTO onco_patient (Hospital,File,Reg,Consult,Full,Age,Birth,Sex,NIC,Address,Tel,Occupation,Marital,Member,Rela,Site,Ref,Topo,Histo,Icdo,Diag,Tnm,Site2,S1,S2,S3,Mul,Rec,Rdate,Treat,Dlast,Remark,Refto,Slast,Nlast) VALUES ('{$Hospital}','{$File}','$Reg','{$Consult}','{$Full}','$Age','$Birth','{$Sex}','{$NIC}','{$Address}','{$Tel}','{$Occupation}','{$Marital}','{$Member}','{$Rela}','{$Site}','{$Ref}','{$Topo}','{$Histo}','{$Icdo}','{$Diag}','{$Tnm}','{$Site2}','{$S1}','{$S2}','{$S3}','{$Mul}','{$Rec}','$Rdate','{$Treat}','$Dlast','{$Remark}','{$Refto}','{$Slast}','{$Nlast}')";
...
if(isset($_POST['check-breast']) && isset($_POST['Submit'])){
    ...
    if(empty($errors)){
        ...
        $duplicate="SELECT File from breast_patient where File='{$File}'";
        $result_dup=mysqli_query($connection,$duplicate);
        $dup=mysqli_fetch_assoc($result_dup);
...
$query= "INSERT INTO breast_patient (Hospital,File,Reg,Consult,Full,Age,Birth,Sex,NIC,Address,Tel,Occupation,Marital,Member,Rela,Site,Ref,Topo,Histo,Icdo,Diag,Tnm,Site2,S1,S2,S3,Mul,Rec,Rdate,Treat,Dlast,Remark,Refto,Slast,Nlast) VALUES ('{$Hospital}','{$File}','$Reg','{$Consult}','{$Full}','$Age','$Birth','{$Sex}','{$NIC}','{$Address}','{$Tel}','{$Occupation}','{$Marital}','{$Member}','{$Rela}','{$Site}','{$Ref}','{$Topo}','{$Histo}','{$Icdo}','{$Diag}','{$Tnm}','{$Site2}','{$S1}','{$S2}','{$S3}','{$Mul}','{$Rec}','$Rdate','{$Treat}','$Dlast','{$Remark}','{$Refto}','{$Slast}','{$Nlast}')";
...
if(isset($_POST['check-os']) && isset($_POST['Submit'])){
    ...
    if(empty($errors)){
        ...
        $duplicate="SELECT File from os_patient where File='{$File}'";
        $result_dup=mysqli_query($connection,$duplicate);
        $dup=mysqli_fetch_assoc($result_dup);
...
$query= "INSERT INTO os_patient (Hospital,File,Reg,Consult,Full,Age,Birth,Sex,NIC,Address,Tel,Occupation,Marital,Member,Rela,Site,Ref,Topo,Histo,Icdo,Diag,Tnm,Site2,S1,S2,S3,Mul,Rec,Rdate,Treat,Dlast,Remark,Refto,Slast,Nlast) VALUES ('{$Hospital}','{$File}','$Reg','{$Consult}','{$Full}','$Age','$Birth','{$Sex}','{$NIC}','{$Address}','{$Tel}','{$Occupation}','{$Marital}','{$Member}','{$Rela}','{$Site}','{$Ref}','{$Topo}','{$Histo}','{$Icdo}','{$Diag}','{$Tnm}','{$Site2}','{$S1}','{$S2}','{$S3}','{$Mul}','{$Rec}','$Rdate','{$Treat}','$Dlast','{$Remark}','{$Refto}','{$Slast}','{$Nlast}')";
...
function myFunction() {
  ...
  if (x.className === "topnav") {
	...
	<div class="input-container">
     <input type="text" name="Hospital" placeholder="Hospital/Institute" autocomplete="off" required>
     <label>Hospital/Institute</label>
    </div>
        
      
   <div class="input-container">
     <input type="text" name="File" placeholder="Clinic File No" autocomplete="off" required>
     <label>Clinic File No</label>
    </div> 
        
      
    <div class="input-container">
     <input type="datetime-local" name="Reg" placeholder="Date of Registration" autocomplete="off">
     <label>Date of Registration</label>
    </div>     
       
    
    <div class="input-container">
     <input type="text" name="Consult" placeholder="Consultant" autocomplete="off">
     <label>Consultant</label>
    </div> 
        
     
    <div class="input-container">
     <input type="text" name="Full" placeholder="Full Name" autocomplete="off" required>
    ...
    <div class="input-container">
     <input type="datetime-local" name="Birth" placeholder="Date of Birth" autocomplete="off">
    ...
    <div class="input-container">
     <input type="text" name="NIC" placeholder="National ID No" autocomplete="off" required>
    ...
    <div class="input-container">
     <input type="text" name="Tel" maxlength="10" placeholder="Telephone N" autocomplete="off">
    ...
    <div class="input-container">
     <input type="text" name="Marital" placeholder="Marital Status" autocomplete="off">
     <label>Marital Status</label>
    </div> 
        
      
    <div class="input-container">
     <input type="text" name="Member" placeholder="Any Family Member Has a Cancer? Yes/No" autocomplete="off">
     <label>Any Family Member Has a Cancer? Yes/No</label>
    </div> 
        
    
    <div class="input-container">
     <input type="text" name="Rela" placeholder="If 'Yes', Relationship" autocomplete="off">
     <label>If 'Yes', Relationship</label>
    </div> 
        
      
    <div class="input-container">
     <input type="text" name="Site" placeholder="Site of Cancer" autocomplete="off">
     <label>Site of Cancer</label>
    </div>
      
      
    <div class="input-container">
     <input type="text" name="Ref" placeholder="Hospital Reffered" autocomplete="off">
