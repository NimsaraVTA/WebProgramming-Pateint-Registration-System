  ...
  if (x.className === "topnav") {
   ...
   <div class="input-container">
    ...
    <div>
     ...
     <label>Add to Onco Clinic</label>
    </div>   
...
<footer>
    ...
    <h1 style="padding:30px; background:#03506F; text-align:center; color:white;">This page can access for admins of Onco Clinic and Breast Clinic only</h1>
