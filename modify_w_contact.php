...
if(isset($_GET['w_name'])){
    ...
    $p_file=mysqli_real_escape_string($connection,$_GET['w_name']);
    
    $query="SELECT * FROM ward_contact WHERE w_name='{$p_file}' LIMIT 1";
    ...
    if($result_set){
        ...
        header('Location: w_contact_list.php?query_falied');
    }
}
...
if(isset($_POST['submit'])){
    ...
    if(empty($errors)){
        ...
        $detail=mysqli_real_escape_string($connection,$_POST['any']);
            ...
            $query= "UPDATE ward_contact SET w_no='{$cont}',w_details='{$detail}',is_deleted='0' WHERE w_name='{$user}'";
            
            $result=mysqli_query($connection,$query);
            
            if($result){
                
                header('Location: w_contact_list.php?contact_added=true');
            }else{
...
<html lang="en">
<head>
	<title>Update ward Contacs</title>
	<meta charset="UTF-8">
...
<body style="background-color: #999999;">
    ...
    <?php
          ...
          if($_SESSION['user_clinic']===$o){
              ...
              $a.='<li><a href="w_contact_list.php">Show Contacts</a></li>';
              $a.='</ul>';
...
<div class="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50">
                        ...
                        <span class="login100-form-title p-b-59">Update Ward Contacts</span>
                                                                                                           
					<div class="wrap-input100 validate-input" data-validate="Name is required">
						<span class="label-input100">Ward's Name</span>
						<input class="input100" type="tele" name="name" placeholder="Ward Name" required value="<?php  echo $wname;?>" readonly>
					...
					<div class="wrap-input100 validate-input" data-validate="Username is required">
						...
						<input class="input100" type="text" name="contact" placeholder="Contact No" required maxlength="10" value="<?php  echo $wno;?>" autocomplete="off">
						<span class="focus-input100"></span>
					</div>

					<div class="wrap-input100 validate-input" data-validate = "Repeat Password is required">
						<span class="label-input100">Any Details</span>
						<input class="input100" type="text" name="any" placeholder="Any Details" value="<?php  echo $wde;?>">
						<span class="focus-input100"></span>
					</div>
