...
?><html>
    ...
    <head>
    <title>Update Patients Breast Clinic</title>
...
{  
  ...
  <a href="B_list.php">Show Patient</a>
  ...
  if (x.className === "topnav") {
    ...
    <div class="row">
        ...
        if(isset($_GET['File'])){
                        ...
                        $query = "SELECT * FROM onco_patient WHERE File='$stud_id' ";
...
<footer>
    ...
    <h1 style="padding:30px; background:#03506F; text-align:center; color:white;">This page can access for admins of Breast Clinic only</h1>
