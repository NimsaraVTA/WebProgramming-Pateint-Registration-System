...
if(isset($_POST['submit'])){
    ...
    if(empty($errors)){
        ...
        $detail=mysqli_real_escape_string($connection,$_POST['any']);
            ...
            $query= "INSERT INTO ward_contact (w_name,w_no,w_details,is_deleted) VALUES ('{$user}', '{$cont}', '{$detail}','0')";
  ...
  <?php
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="login100-more" style="background-image: url('ward.jpg');"></div>

<div class="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50">
    
                        <form class="login100-form validate-form" method="post">
                        <span class="login100-form-title p-b-59">Add Wards' Contacts</span>
                                                                                                           
					<div class="wrap-input100 validate-input" data-validate="Name is required">
						<span class="label-input100">Ward's Name</span>
						<input class="input100" type="tele" name="name" placeholder="Ward Name" required>
					...
					<div class="wrap-input100 validate-input" data-validate="Username is required">
						...
						<input class="input100" type="text" name="contact" placeholder="Contact No" required maxlength="10">
						<span class="focus-input100"></span>
					</div>

					<div class="wrap-input100 validate-input" data-validate = "Repeat Password is required">
						<span class="label-input100">Any Details</span>
						<input class="input100" type="text" name="any" placeholder="Any Details">
						<span class="focus-input100"></span>
					</div>
