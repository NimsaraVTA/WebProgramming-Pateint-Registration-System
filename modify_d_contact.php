...
if(isset($_POST['submit'])){
    ...
    if(empty($errors)){
        ...
        $detail=mysqli_real_escape_string($connection,$_POST['any']);
            ...
            $query= "UPDATE doctor_contact SET d_no='{$cont}',d_details='{$detail}',is_deleted='0' WHERE d_name='{$user}'";
...
<html lang="en">
<head>
	<title>Update Doctors Contacs</title>
	<meta charset="UTF-8">
...
<div class="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50">
                        ...
                        <span class="login100-form-title p-b-59">Update Doctors' Contacts</span>
