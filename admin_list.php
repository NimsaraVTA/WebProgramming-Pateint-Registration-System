...
$query="SELECT * FROM user where is_deleted=0 ORDER BY username";
...
if($users){
    ...
    while($user=mysqli_fetch_assoc($users)){
      $userlist.="<tr>";
        ...
        $userlist.="<td><a href=\"modify_admin.php?username={$user['username']}\">Edit</a></td>";
        $userlist.="<td><a href=\"delete_admin.php?username={$user['username']}\">Delete</a></td>";
      $userlist.='<tr>';    
...
<div class="topnav" id="myTopnav">
  ...
  <a href="AO_update_b.php">Modify Admin</a>
...
<h2 style="text-align:center; padding:15px;">Admin List - Onco Clinic</h2>
