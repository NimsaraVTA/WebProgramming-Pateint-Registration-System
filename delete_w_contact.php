...
if(isset($_POST['submit'])){
    ...
    if(empty($errors)){
        ...
        $detail=mysqli_real_escape_string($connection,$_POST['any']);
            ...
            $query= "DELETE FROM ward_contact WHERE w_name='{$user}'";
...
<html lang="en">
<head>
	<title>Delete ward Contacs</title>
	<meta charset="UTF-8">
...
<div class="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50">
                        ...
                        <span class="login100-form-title p-b-59">Delete Ward Contacts</span>
					...
					<div class="wrap-input100 validate-input" data-validate="Username is required">
						...
						<input class="input100" type="text" name="contact" placeholder="Contact No" required maxlength="10" value="<?php  echo $wno;?>">
						<span class="focus-input100"></span>
					</div>
