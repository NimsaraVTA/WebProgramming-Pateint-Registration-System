...
if(isset($_GET['search'])){
  ...
  /*...............................................................................*/
      ...
      $query3="SELECT File FROM breast_patient WHERE File={$p_file} LIMIT 1";
...
?><html>
    ...
    <head>
    <title>Update Patients Onco Surgeory Clinic</title>
...
{  
  ...
  <a href="OS_list.php">Show Patient</a>
...
function myFunction() {
  ...
  if (x.className === "topnav") {
    ...
    <div id="srch"><div class="container3">
        ...
        <div class="row">
        <div class="col-md-8">
        <input type="text" name="File" value="<?php if(isset($_GET['File'])){echo $_GET['File'];} ?>" class="form-control" placeholder="Enter File Number" autocomplete="off">
        </div>
        <div class="col-md-4">
    ...
    <div class="row">
        ...
        if(isset($_GET['File'])){
                        ...
                        $query = "SELECT * FROM os_patient WHERE File='$stud_id' ";
   ...
   <hr/><br><br> 
	...
	<div class="input-container">
     <input type="text" name="Hospital" placeholder="Hospital/Institute" autocomplete="off" required value="<?php if(isset($_GET['File'])){echo $row['Hospital'];} else{echo '';} ?>">
     <label>Hospital/Institute</label>
    </div>
        
      
   <div class="input-container">
     <input type="text" name="File" placeholder="Clinic File No" autocomplete="off" required value="<?php if(isset($_GET['File'])){echo $row['File'];} else{echo '';} ?>">
     <label>Clinic File No</label>
    </div> 
        
      
    <div class="input-container">
     <input type="datetime-local" name="Reg" placeholder="Date of Registration" autocomplete="off" value="<?php if(isset($_GET['File'])){echo $row['Reg'];} else{echo '';} ?>">
     <label>Date of Registration</label>
    </div>     
       
    
    <div class="input-container">
     <input type="text" name="Consult" placeholder="Consultant" autocomplete="off" value="<?php if(isset($_GET['File'])){echo $row['Consult'];} else{echo '';} ?>">
     <label>Consultant</label>
    </div> 
        
     
    <div class="input-container">
     <input type="text" name="Full" placeholder="Full Name" autocomplete="off" required value="<?php if(isset($_GET['File'])){echo $row['Full'];} else{echo '';} ?>">
     <label>Full Name</label>
    </div> 
        
     
    <div class="input-container">
     <input type="text" name="Age" placeholder="Age" autocomplete="off" value="<?php if(isset($_GET['File'])){echo $row['Age'];} else{echo '';} ?>">
     <label>Age</label>
    </div> 
        
    
    <div class="input-container">
     <input type="datetime-local" name="Birth" placeholder="Date of Birth" autocomplete="off" value="<?php if(isset($_GET['File'])){echo $row['Birth'];} else{echo '';} ?>">
     <label>Date of Birth</label>
    </div>
      
     
    <div class="input-container">
     <input type="text" name="Sex" placeholder="Sex" autocomplete="off" value="<?php if(isset($_GET['File'])){echo $row['Sex'];} else{echo '';} ?>">
     <label>Sex</label>
    </div>    
        
 
    <div class="input-container">
     <input type="text" name="NIC" placeholder="National ID No" autocomplete="off" required value="<?php if(isset($_GET['File'])){echo $row['NIC'];} else{echo '';} ?>">
    ...
    <div class="input-container">
     <input type="text" name="Address" placeholder="Address" autocomplete="off" value="<?php if(isset($_GET['File'])){echo $row['Address'];} else{echo '';} ?>">
     <label>Address</label>
    </div>
        
       
    <div class="input-container">
     <input type="text" name="Tel" maxlength="10" placeholder="Telephone N" autocomplete="off" value="<?php if(isset($_GET['File'])){echo $row['Tel'];} else{echo '';} ?>">
     <label>Telephone No</label>
    </div> 
        
      
    <div class="input-container">
     <input type="text" name="Occupation" placeholder="Occupation" autocomplete="off" value="<?php if(isset($_GET['File'])){echo $row['Occupation'];} else{echo '';} ?>">
     <label>Occupation</label>
    </div>     
       
    
    <div class="input-container">
     <input type="text" name="Marital" placeholder="Marital Status" autocomplete="off" value="<?php if(isset($_GET['File'])){echo $row['Marital'];} else{echo '';} ?>">
     <label>Marital Status</label>
    </div> 
        
      
    <div class="input-container">
     <input type="text" name="Member" placeholder="Any Family Member Has a Cancer? Yes/No" autocomplete="off" value="<?php if(isset($_GET['File'])){echo $row['Member'];} else{echo '';} ?>">
     <label>Any Family Member Has a Cancer? Yes/No</label>
    </div> 
        
    
    <div class="input-container">
     <input type="text" name="Rela" placeholder="If 'Yes', Relationship" autocomplete="off" value="<?php if(isset($_GET['File'])){echo $row['Rela'];} else{echo '';} ?>">
     <label>If 'Yes', Relationship</label>
    </div> 
        
      
    <div class="input-container">
     <input type="text" name="Site" placeholder="Site of Cancer" autocomplete="off" value="<?php if(isset($_GET['File'])){echo $row['Site'];} else{echo '';} ?>">
     <label>Site of Cancer</label>
    </div>
      
      
    <div class="input-container">
     <input type="text" name="Ref" placeholder="Hospital Reffered" autocomplete="off" alue="<?php if(isset($_GET['File'])){echo $row['Ref'];} else{echo '';} ?>">
   ...
   <div class="input-container">
    ...
    <div>
     ...
     <label>Update Onco Clinic</label>
    </div>   
...
<footer>
    ...
    <h1 style="padding:30px; background:#03506F; text-align:center; color:white;">This page can access for admins of Onco and Onco Surgeory Clinic only</h1>
